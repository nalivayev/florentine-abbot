...
> **Important:** This guide is dedicated exclusively to digitizing analog media (paper photos, film).
...
*   If the album is thick and the scanner lid does not close — cover it with a sheet of black paper and press down with your hand (gently!). Or use re-photographing with a camera.
