"""Unified logging system for Scan Batcher.
...
class Logger:
    """
    Centralized logging configuration and path management for Scan Batcher.
    ...
    Features:
        ...
        - Environment variable support (SCAN_BATCHER_LOG_DIR)
    ...
    def __init__(
        ...
        Args:
            module_name (str): Name of the module (e.g., "scan_batcher").
