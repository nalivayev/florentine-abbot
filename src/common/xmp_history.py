...
class XmpHistory:
    ...
    - 'managed': Metadata management without content change
    - 'derived': New file derived from source
    """
    ...
    def append_entry(
        ...
        Args:
            ...
            software_agent: Software that performed action, e.g. 'scan-batcher 1.0.5'
