...
Проект в некоторой степени реализует подходы эталонной модели **OAIS (Open Archival Information System)** (ISO 14721) — стандарта для долгосрочного хранения данных, используемого архивами и библиотеками, например в NASA, где, собственно, и был разработан.
