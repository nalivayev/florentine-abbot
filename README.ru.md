...
> **⚠️ Статус**: В разработке. Пока не полностью протестирована или документирована. Не входит в устанавливаемый пакет; запускать из исходников.
...
```sh
python -m file_organizer.preview_maker --path "D:\Archive\PHOTO_ARCHIVES" --max-size 2000 --quality 80
```

**С перезаписью существующих PRV:**
```sh
python -m file_organizer.preview_maker --path "D:\Archive\PHOTO_ARCHIVES" --max-size 2400 --quality 85 --overwrite
```
