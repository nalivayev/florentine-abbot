...
Scan Batcher — это проект, посвященный сканированию и цифровой организации домашних фотоархивов. Он состоит из инструментов для автоматизации процесса сканирования и организации полученных файлов с правильными метаданными.
