...
Scan Batcher в некоторой степени реализует подходы эталонной модели **OAIS (Open Archival Information System)** (ISO 14721) — стандарта для долгосрочного хранения данных, используемого национальными архивами и библиотеками (NASA, Библиотека Конгресса).
