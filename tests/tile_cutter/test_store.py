"""Regression tests for CutterStore database-boundary behavior."""
...
class TestCutterStore:
    """Covers the package-local DB boundary used by Cutter."""
    ...
    def test_list_pending_files_returns_only_pending_tile_tasks(self) -> None:
        ...
        with CutterStore(self.archive_path) as store:
    ...
    def test_mark_failed_updates_tile_task_row(self) -> None:
        conn = self.database.get_conn()
