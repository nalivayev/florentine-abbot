...
from common.constants import TAG_XMP_DC_FORMAT, TAG_IFD0_MAKE, TAG_IFD0_MODEL, TAG_IFD0_SOFTWARE, TAG_XMP_EXIF_DATETIME_DIGITIZED, TAG_EXIF_OFFSET_TIME_DIGITIZED
