...
def test_scan_modified_file(scanner, archive_path, db_manager):
...
def test_scan_missing_file(scanner, archive_path, db_manager):
...
def test_scan_recovered_file(scanner, archive_path, db_manager):
...
def test_scan_corrupted_file(scanner, archive_path, db_manager):
